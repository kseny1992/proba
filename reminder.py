...
def set(): #установка
    ...
    if rem:
        try:
            ...
            print(t)
            text = sd.askstring("Текст напоминания","Ведите текст напоминания") #напоминаем себе для чего устанавливали напоминание
            label.config(text= f"Напоминание установлено на: {hour:02}:{minute:02} с текстом {text}") #напоминание на какое время установили напоминание
            #и 2 символа на минуты и секунды
        except ValueError:
